...
const Hero = () => {
  ...
  return <section ref={heroRef} className="relative min-h-screen flex items-center justify-center py-20 px-6 md:px-10 opacity-0" style={{
    backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(78, 253, 0, 0.15) 0%, rgba(0, 0, 0, 0) 60%)'
      ...
      <div className="max-w-6xl text-center z-10 my-px mx-0 px-0 py-[71px]">
        ...
        <div className="mt-16 opacity-0 animate-slide-up" style={{
        animationDelay: '1.1s'
      }}>
          <div className="flex flex-wrap justify-center gap-2 md:gap-4">
            ...
            label: "Scale"
                ...
                {index < 5 && <svg className="w-4 h-4 md:w-6 md:h-6 text-gray-300 mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
