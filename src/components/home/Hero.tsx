  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 left-1/3 w-1 h-1 bg-synkris-green rounded-full animate-pulse-green" 
          style={{ animationDelay: '1s' }}
        />
        <div className="absolute top-2/3 right-1/3 w-1 h-1 bg-synkris-green rounded-full animate-pulse-green"
          style={{ animationDelay: '2s' }}
        />
      </div>
      
      <div className="max-w-6xl mx-auto text-center z-10">
        <div className="inline-block mb-6 animate-slide-down opacity-0" style={{ animationDelay: '0.3s' }}>
          <span className="px-4 py-1.5 rounded-full bg-synkris-green/10 text-synkris-green font-medium text-sm border border-synkris-green/20">
            India's First Cloud Kitchen Operations Platform
          </span>
        </div>
        
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tight animate-slide-down opacity-0" style={{ animationDelay: '0.5s' }}>
          The Cloud Kitchen, <br />
          <span className="text-synkris-green">for Cloud Kitchens</span>
        </h1>
        
        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-10 animate-slide-down opacity-0" style={{ animationDelay: '0.7s' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 animate-slide-down opacity-0" style={{ animationDelay: '0.9s' }}>
      ...
      <div className="absolute bottom-10 left-0 right-0 mx-auto max-w-4xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 glass-panel p-4 animate-slide-up opacity-0" style={{ animationDelay: '1.2s' }}>
